...
- 🏷️ **Jira release-driven autocheck**:
  - По нажатию `F11` во вкладке веток можно запустить автоматическую пометку кандидатов на удаление на основе статуса релиза в Jira.
...
- **`F11`**: Запуск Jira release-driven autocheck.
...
**Процесс работы:**
1. Нажмите **`F11`** во вкладке веток.
...
- **No Silent Auto-run**: Запросы к Jira API для проверки релизов выполняются только по явному нажатию `F11`.
